...
# ============================================
# Custom native pages (authored directly, not from Confluence)
# ============================================

FIVE_RESPECTS_FILE = "The-Five-Respects_500000001.html"

FIVE_RESPECTS_SNIPPET = (
    "The thesis: communicating a perception of another's developmental stage creates a power "
    "dynamic that is not respectful. Five distinct flavors of respect — Man to Man, Man to Woman, "
    "Man to Animal, Man to God, Man to Authority — mapped in the spirit of C.S. Lewis's The Four Loves."
)


def generate_five_respects_page(title):
    """Native reference page for The Five Respects (Perry Dime Publications)."""
    return '''<h1 class="page-title">The Five Respects</h1>
<div class="page-meta">Perry Dime Publications · September 5, 2026 · a reference document toward a book</div>
<div class="article-content fr-doc">

<style>
.fr-doc { --fr-oxblood:#6e2b2b; --fr-gold:#9c7b34; --fr-forest:#2f5d4f; --fr-slate:#33465a; }
.fr-doc .fr-whys { font-style:italic; color:var(--fr-oxblood); font-size:1.15rem; margin:0.2em 0 1.2em; }
.fr-doc .fr-thesis { margin:1.6em 0; padding:1.1em 1.4em; background:var(--color-accent-light); border-left:5px solid var(--fr-oxblood); border-radius:6px; }
.fr-doc .fr-thesis .fr-label { font-variant:small-caps; letter-spacing:0.18em; font-size:0.72rem; color:var(--fr-oxblood); display:block; margin-bottom:0.3em; }
.fr-doc .fr-thesis blockquote { margin:0; font-size:1.25rem; line-height:1.4; font-style:italic; color:var(--color-text); border:0; padding:0; }
.fr-doc .fr-calc { background:#22201c; color:#f3ecda; border-radius:8px; padding:1.2em 1.4em; margin:1.4em 0; }
.fr-doc .fr-calc .fr-h { font-variant:small-caps; letter-spacing:0.18em; font-size:0.72rem; color:#c39a45; display:block; margin-bottom:0.7em; }
.fr-doc .fr-calc .fr-line { font-size:1.15rem; text-align:center; line-height:1.9; font-family:"Cambria Math","STIX Two Math",Georgia,serif; }
.fr-doc .fr-calc .fr-op { color:#c39a45; padding:0 0.35em; font-weight:600; }
.fr-doc .fr-calc .fr-gloss { display:block; font-size:0.84rem; font-style:italic; color:#b8ae97; text-align:center; margin-top:0.5em; }
.fr-doc .fr-matrix { display:grid; grid-template-columns:repeat(3,1fr); gap:6px; max-width:460px; margin:1.2em auto 0.4em; }
.fr-doc .fr-cell { padding:14px 8px; border-radius:6px; text-align:center; color:#23201b; font-weight:600; border:1px solid rgba(0,0,0,0.1); }
.fr-doc .fr-cell small { display:block; font-variant:small-caps; letter-spacing:0.1em; font-weight:400; opacity:0.7; font-size:0.7rem; }
.fr-doc .c-i{background:#7fae6b} .fr-doc .c-you{background:#a9c06a} .fr-doc .c-he{background:#d8c569}
.fr-doc .c-we{background:#b9c069} .fr-doc .c-yall{background:#dca85f} .fr-doc .c-they{background:#cf7a5a}
.fr-doc .fr-cap { text-align:center; font-size:0.86rem; font-style:italic; color:var(--color-text-muted); margin:0.5em 0 1.4em; }
.fr-doc .fr-triad { display:flex; gap:12px; flex-wrap:wrap; margin:1.3em 0; }
.fr-doc .fr-petal { flex:1 1 170px; border-radius:8px; padding:14px 16px; color:#fff; }
.fr-doc .fr-petal h4 { margin:0 0 4px; color:#fff; } .fr-doc .fr-petal p { margin:0; font-size:0.9rem; color:rgba(255,255,255,0.94); }
.fr-doc .fr-petal small { font-variant:small-caps; letter-spacing:0.12em; opacity:0.85; }
.fr-doc .p-passion{background:var(--fr-oxblood)} .fr-doc .p-balance{background:var(--fr-gold)} .fr-doc .p-solvency{background:var(--fr-slate)}
.fr-doc .fr-flow { display:flex; align-items:center; justify-content:center; gap:10px; flex-wrap:wrap; margin:1.3em 0 0.4em; }
.fr-doc .fr-node { background:var(--color-surface); border:1px solid var(--color-border); border-radius:8px; padding:12px 16px; text-align:center; }
.fr-doc .fr-node b { color:var(--fr-oxblood); font-size:1.25rem; display:block; } .fr-doc .fr-node span { font-size:0.8rem; color:var(--color-text-muted); font-style:italic; }
.fr-doc .fr-arrow { color:var(--fr-gold); font-size:1.5rem; }
.fr-doc .fr-respects { display:grid; gap:14px; margin:1.4em 0; }
.fr-doc .fr-rcard { border:1px solid var(--color-border); border-left:5px solid var(--fr-gold); border-radius:6px; padding:14px 18px; background:var(--color-surface); }
.fr-doc .fr-rcard .fr-rk { font-variant:small-caps; letter-spacing:0.16em; color:var(--fr-gold); font-size:0.72rem; }
.fr-doc .fr-rcard h3 { margin:0.1em 0 0.4em; color:var(--fr-oxblood); }
.fr-doc .fr-rcard.r1{border-left-color:var(--fr-slate)} .fr-doc .fr-rcard.r2{border-left-color:var(--fr-oxblood)}
.fr-doc .fr-rcard.r3{border-left-color:var(--fr-forest)} .fr-doc .fr-rcard.r4{border-left-color:var(--fr-gold)} .fr-doc .fr-rcard.r5{border-left-color:#5a4a6e}
.fr-doc .fr-stack { max-width:520px; margin:1.2em auto; }
.fr-doc .fr-rung { display:flex; align-items:center; gap:12px; margin:8px 0; }
.fr-doc .fr-rung .fr-n { flex:0 0 auto; width:38px; height:38px; border-radius:50%; background:var(--fr-oxblood); color:#fff; display:flex; align-items:center; justify-content:center; font-weight:600; }
.fr-doc .fr-rung .fr-b { flex:1; background:var(--color-surface); border:1px solid var(--color-border); border-radius:6px; padding:8px 12px; }
.fr-doc .fr-download { display:inline-flex; align-items:center; gap:8px; margin:0.4em 8px 0.4em 0; padding:10px 16px; background:var(--fr-oxblood); color:#fff; border-radius:8px; text-decoration:none; font-weight:500; }
.fr-doc .fr-download.alt { background:var(--fr-gold); }
.fr-doc .fr-download:hover { opacity:0.92; }
</style>

<p class="fr-whys">&ldquo;But why? &nbsp;Really — but <em>why?</em>&rdquo;</p>

<p>A reference document toward a future book, mapped in the spirit of C.S. Lewis's <em>The Four Loves</em>: five genuinely distinct flavors of respect, and the philosophy that produces them. Read it with the keynote it was written in — curiosity.</p>

<div>
<a class="fr-download" href="https://PerryDime.com" target="_blank" rel="noopener">Perry Dime Publications ↗</a>
<a class="fr-download alt" href="mailto:jefferson@richards.plus">jefferson@richards.plus</a>
</div>

<h2>I. The Core Thesis</h2>
<p>Begin with the tone, because the tone is the argument. In life we are almost never given transparency about our perceived developmental stage. We each balance many accounts at once — not only financial, but social, and accounts of scope: our grasp of the world, our skills, our reach into the philosophical, our sense of what it means to mature, and of what it means to be true to our own nature. Being true to your nature is load-bearing here — so is that more radical instruction, <em>love thy enemy</em>, which both Marcus Aurelius and Jesus insist upon.</p>

<div class="fr-thesis">
    <span class="fr-label">The Thesis</span>
    <blockquote>Communicating a perception of another's developmental stage creates a power dynamic that is not respectful.</blockquote>
</div>

<p>With age you feel the reason we do not broadcast how we perceive one another's development. And a corollary worth stating plainly: <strong>when you're getting flack, you're on the mark.</strong> People do not have infinite energy to spend on everyone they meet.</p>

<h2>II. Developmental Stage &amp; the Absence of Transparency</h2>
<p>The neighborhood watch never tells Jim, &ldquo;fix your lawn and we'll let you in.&rdquo; A family doesn't fold the kids into the tax return. People grasp this instinctively. But in a hyper-communicative age we arrive at a matrix of educated and uneducated, in-group and out-group — and the in-group treats every other quadrant as a lesser stage. <strong>Public health is the cleanest example:</strong> a message declared true and good for one group but requiring a softened version for another. That is truth being warped — and it originates in something tender: our empathy for the parent who learned to meet a child at its stage, turned outward onto other adults as a kind of toxic empathy.</p>

<h2>III. The Openness Matrix</h2>
<p>Arrange the persons of grammar into a matrix — <em>I, you, he/she/it, we, y'all, they</em>. Openness is an <em>arc</em> across it. Favoring the top-left, most of the field is green (good, admitted) and only a wedge of <em>they</em> reads red. Low openness inverts it: even parts of <em>I</em> and <em>we</em> read as bad. It is a gradient of how open you are to the stranger.</p>
<div class="fr-matrix">
    <div class="fr-cell c-i"><small>1st sing.</small>I</div>
    <div class="fr-cell c-you"><small>2nd sing.</small>You</div>
    <div class="fr-cell c-he"><small>3rd sing.</small>He / She / It</div>
    <div class="fr-cell c-we"><small>1st plur.</small>We</div>
    <div class="fr-cell c-yall"><small>2nd plur.</small>Y'all</div>
    <div class="fr-cell c-they"><small>3rd plur.</small>They</div>
</div>
<p class="fr-cap">Green is &ldquo;good / admitted&rdquo;; red is &ldquo;suspect.&rdquo; Openness is the arc that decides how much of the stranger you let into the green.</p>

<h2>IV. Xenia — 0→1 and 1→Many</h2>
<p>This matters because of <em>xenia</em> — Zeus's law, the sacred entertaining of the stranger. Going from <strong>0 to 1</strong> in love is nearly impossible; Jesus is the epitome of that originating act. Going from <strong>1 to many</strong> — extending what exists once — is almost infinitely easier. Which is what makes Marcus Aurelius astonishing: he reached so many of the 1→many points <em>without</em> the 0→1 in front of him. Perhaps xenia was his own 0→1.</p>
<div class="fr-flow">
    <div class="fr-node"><b>0 → 1</b><span>the originating act (nearly impossible)</span></div>
    <div class="fr-arrow">⟶</div>
    <div class="fr-node"><b>1 → Many</b><span>derivation &amp; extension (far less costly)</span></div>
</div>

<h2>V. What Gets You Into Pursuit</h2>
<p>By Locke's definition, the pursuit of happiness is the pursuit of what you pursue — pleasingly circular. The better question: <em>what puts you into a state of pursuit?</em> Three valid answers; being true to your nature means honoring whichever is yours.</p>
<div class="fr-triad">
    <div class="fr-petal p-passion"><small>the feminine</small><h4>Passion</h4><p>The pull that ignites the chase.</p></div>
    <div class="fr-petal p-balance"><small>the neutral</small><h4>Balance</h4><p>The equilibrium that sustains.</p></div>
    <div class="fr-petal p-solvency"><small>the masculine</small><h4>Solvency</h4><p>In the Austen sense — ground to stand on.</p></div>
</div>
<p>Relationships begin in <strong>play</strong>. As you play you learn people's boundaries through the needs and values they express — the foundation of <em>the language of their respect</em>. That companion set, the languages of respect, is why this book is not yet complete.</p>

<h2>VI. Defining the Good</h2>
<p>In a literal sense, the good is <strong>pro-social, cooperative behavior that encourages transaction by maintaining morale</strong> — libido sublimated into cooperation. Its companion: <strong>independence is not maturity; interdependence is maturity.</strong> Marcus Aurelius and Jesus emphasize the <em>independence</em> within interdependence; much of society emphasizes the <em>dependence</em>, insisting <em>you are not sufficient without us</em> — manufacturing insufficiency to extract value through see → desire → take loops.</p>

<h2>VII. Self-Governance &amp; the Fabric of Solidarity</h2>
<p>The antidote is self-governance, held together by a <strong>fabric of solidarity</strong> — a honey of a certain viscosity. In peacetime it is thick enough to keep us from breaking social norms; in wartime the viscosity fails and the fabric we take for granted is lost.</p>

<h2>VIII. Freedom as Chosen Debt</h2>
<p>From <em>Debt: The First 5,000 Years</em>: two old women miles apart. One brings a cup of sugar; the other returns only half — &ldquo;I guess I'll have to come back tomorrow.&rdquo; A full cup returned would prompt: <em>why don't you want to be in debt to me?</em></p>
<div class="fr-thesis" style="border-left-color:var(--fr-forest)">
    <span class="fr-label" style="color:var(--fr-forest)">Freedom, defined</span>
    <blockquote>Freedom is choosing with whom you are in debt — choosing to whom you are beholden.</blockquote>
</div>

<h2>IX. A Little Predicate Calculus</h2>
<div class="fr-calc">
    <span class="fr-h">The parental pair</span>
    <div class="fr-line">Necessity <span class="fr-op">⟶</span> Invention</div>
    <div class="fr-line">Responsibility <span class="fr-op">⟶</span> Accomplishment</div>
    <span class="fr-gloss">If necessity is the mother of invention, then responsibility is the father of accomplishment.</span>
</div>
<div class="fr-calc">
    <span class="fr-h">Optionality and loyalty are biconditional</span>
    <div class="fr-line">Optionality <span class="fr-op">⟺</span> Loyalty</div>
    <span class="fr-gloss">Loyalty with no options is bending the knee to a king who never moves. Optionality that can never commit is not real optionality — it never collapses into something anyone can depend on. (From the prior book, <em>Put Options on Loyalty</em>.)</span>
</div>
<div class="fr-calc">
    <span class="fr-h">Choice presupposes order</span>
    <div class="fr-line">Axiom of Choice <span class="fr-op">⟺</span> Well-Ordered Set</div>
    <span class="fr-gloss">Order is a precondition of choice — which is why freedom of religion is numbered first.</span>
</div>
<p>Chain the conditionals and they terminate in <strong>purpose</strong>: passion, solvency, and balance alleviate necessity; we aim to survive with <em>vitality</em>; and self-governance paired with self-imposed responsibility turns freedom into the choosing of your own responsibilities.</p>

<h2>X. The Five Respects</h2>
<div class="fr-respects">
    <div class="fr-rcard r1">
        <span class="fr-rk">The First Respect</span>
        <h3>Man → Man</h3>
        <p>Rooted in the hunt. Risk spikes dopamine; a successful hunt delivers the serotonin. A man needs to take risk to differentiate fully into manhood — toiling in the dust for daily bread (Genesis), appropriating resources into the household. That role is well fit to his nature.</p>
    </div>
    <div class="fr-rcard r2">
        <span class="fr-rk">The Second Respect</span>
        <h3>Man → Woman</h3>
        <p>A different flavor entirely. Feminine differentiation is not the taking-on of risk; a woman is fully differentiated in <em>managing with</em> the household's resources — and in feeling the pain of her children. A rite of passage for a man is learning that a woman wants a <em>different kind</em> of respect (as Orion Taraban's <em>The Value of Others</em> frames the copulation dynamic). The New Testament's asymmetric command — <em>men, love your wives; women, respect your husbands</em> — is here derived, not assumed: a fruiting body from the mycelium of everything above.</p>
    </div>
    <div class="fr-rcard r3">
        <span class="fr-rk">The Third Respect</span>
        <h3>Man → Animal</h3>
        <p>The one I understand least, so I leave it honest and unfinished. Fragments: my cousin's Kentucky dogs, happiest because they were true to their nature; the indigenous intuition that the gazelle in some sense chooses its moment with the lion; the fly that sat still as the lizard ate it. Something in the predator–prey model (Lotka–Volterra) and in morale models — active and passive — is the substance here. <em>(Include the epidemiological case: in STD spread, transmission runs to the passive partner; when both partners switch between active and passive roles, the disease propagates through the community — a morale model the CDC uses for the spread of AIDS.)</em> Even the oldest war on earth — bacteria against fungus — belongs here.</p>
    </div>
    <div class="fr-rcard r4">
        <span class="fr-rk">The Fourth Respect</span>
        <h3>Man → God</h3>
        <p>Best entered through <em>fear and awe</em> — Yosemite, where I felt both. The insurance industry keeps a category for <em>acts of God</em>. My claim: what was once an act of God may cease to be one, but there will always be acts of God, because it costs too much to model what we call random. It is also uncomfortably conducive to a surveillance age now literally substantiated by biometrics and demographic proxies. I believe in freedom of religion; salvation is one's own responsibility. Out of that optionality I choose Christianity and stoicism — with the modern privilege of assembling the ancient word from many texts. There are macro-synapses and micro-synapses in this cosmic mind of intricate, fractal design — the Strait of Hormuz, the Silk Road.</p>
    </div>
    <div class="fr-rcard r5">
        <span class="fr-rk">The Fifth Respect</span>
        <h3>Man → Authority</h3>
        <p>The order matters. The First Amendment is <em>one</em>: 1.1 freedom of religion, 1.2 freedom of speech, 1.3 freedom to assemble and air grievances — religion first, because the axiom of choice is biconditional with the well-ordered set. Groups develop through free play → instrumental play → deliberative play. So ask, in the keynote tone: <em>but why</em> would authority be incentivized to keep people from reaching the deliberative stage where they air grievances? Respect for authority is real, but it is <em>not natural</em> to treat authority as equivalent to God — these are fellow people holding a monopoly on legitimate violence. And the thesis ripples through: authority will never tell you its perception of your developmental stage, within accounts it does not even profess to keep.</p>
    </div>
</div>

<div class="fr-stack">
    <div class="fr-rung"><div class="fr-n">1</div><div class="fr-b"><strong>Freedom of religion</strong> — first, because order precedes choice</div></div>
    <div class="fr-rung"><div class="fr-n">2</div><div class="fr-b"><strong>Freedom of speech</strong> — enabled once the first is in place</div></div>
    <div class="fr-rung"><div class="fr-n">3</div><div class="fr-b"><strong>Freedom to assemble &amp; air grievances</strong> — the deliberative end of play</div></div>
</div>
<p class="fr-cap">The well-ordered set of the First Amendment. Groups move: free play → instrumental play → deliberative play.</p>

<h2>XI. Coda</h2>
<p>The thesis closes the circle: <strong>communicating a perception of another's developmental stage creates a power dynamic that is not respectful</strong> — which is why life so rarely hands you the transparency you crave. Wisdom, in Proverbs, begins in the fear of God and grows by seeking understanding. Man→Man, Man→Woman, Man→Animal, Man→God, Man→Authority — five distinct flavors of the same underlying material. The rest I keep learning. For now: <em>but why?</em> Keep asking.</p>

<hr>
<p style="color:var(--color-text-muted);font-size:0.9rem;"><em>The Five Respects</em> · Perry Dime Publications · <a href="https://PerryDime.com" target="_blank" rel="noopener">PerryDime.com</a> · <a href="mailto:jefferson@richards.plus">jefferson@richards.plus</a></p>
